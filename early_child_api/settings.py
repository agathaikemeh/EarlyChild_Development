...
SECRET_KEY = 'django-insecure-gzb%zmkgka-lqm+k97olbu036aw$!etduof(55!@@8h_h30&0h'
...
ROOT_URLCONF = 'early_child_api.urls'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # Ensure this is in the list
    ],
